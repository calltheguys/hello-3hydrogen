...
const isOrthographicCamera = (def) => def.isOrthographicCamera;
const col = new THREE.Color();

function Container({scene, index, children, frames, rect, track}) {
...
export function ViewTracking() {
  const ref = useRef();
  const [view1, view2, view3, view4, view5] = useRefs();
  return (
